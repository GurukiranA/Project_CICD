...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds1815")
    bq_project = Variable.get("bq_project", default_var="sturdy-plateau-450011-q7")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflow_project/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflow_project/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "186548568444-compute@developer.gserviceaccount.com",
                "network_uri": "projects/sturdy-plateau-450011-q7/global/networks/default",
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="sturdy-plateau-450011-q7",
        region="us-central1",
